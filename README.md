...
- Timestamp: `2022-05-30 19:52`
- Build ID: `8dc7644f-e6d8-432f-b219-c20cbc11eb05`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/8dc7644f-e6d8-432f-b219-c20cbc11eb05.git
$ cd 8dc7644f-e6d8-432f-b219-c20cbc11eb05
```
